...
small group homes, with 10 to 12 children in each home, in the Parika area.</p>
			<p>Reaching and accessing the children can be difficult. We work with the Social Services, local people and also local organisations, such as the church, to help identify the children who would benefit from a placement in a Jesus In Action home.</p>
			</div>
		</div>
		...
		<div class="large-6 column">
			...
			<ul>
				...
				<li>Help improve their self-esteem and build a positive self-image.</li> 
				...
				<li>Steer them away from becoming involved in crime and drugs</li> 
				<li>Protect children from harm, neglect and exploitation by others.</li> 
				<li>Listen to the children and take theirs views into account.</li> 
				<li>Establish a market garden/farm, providing some food for the children (vegetables, fruit and appropriate livestock e.g. chickens).</li>
			</ul>
		</div>
	</div>
