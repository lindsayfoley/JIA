...
<html>
<head>
<title>Recap of events in 2013 | News Archive | Jesus In Action Charity</title>
<?php include('../structure/meta.php'); ?>
<meta name="description" content="From fundraising initiatives to project openings - here is a recap of what Jesus In Action achieved in 2013">
...
<div id="container">
	...
	<main>
		<div>
			<h3>News - 2013</h3>
			<p class="sub_header">Help with the plumbing!</p>
			...
			<a class="more-articles" href="/news">Back &gt;</a>
		</div>
