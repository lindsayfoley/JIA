    ...
    <div id="container">
        ...
        <main>
            <div id="support_container">
                <div id="donations">
                    <img class="image_box" src="images/support_donations.jpg" alt="Help with donations">
                    <div class="text_box">
                        ...
                        <p>Supporters of JIA in England have shipped several barrels of goods which have been distributed in the area. Donations of children's clothing (in a presentable condition) and tinned foods as we ship large barrels of these necessities to Guyana and share these amongst those who need it most. For a list of the food items that we can ship please <a href="mailto:info@jesusinaction.org.uk">send us an email</a> with 'other donation' as the subject line and we will respond back with the required details.</p>
                    </div>
                </div>

                <div id="time">
                    <img class="image_box" src="images/support_time.jpg" alt="Help with your time">
                    <div class="text_box">
                        ...
                        <p>You can volunteer in London, or if based in Guyana, you can help us too. If there are any areas where you think you could assist us, please <a href="mailto:info@jesusinaction.org.uk">contact us here</a> and we will contact you to discuss this further.</p>
                    </div>
                </div>

                <div id="fundraising">
                    <img class="image_box" src="images/support_fundraising.jpg" alt="Help with fundraising">
                    <div class="text_box">
                        ...
                        <ul>
                            <li><strong>Get active</strong> - take on a physical challenge and raise money by being sponsored to get moving and active.</li>
                            <li><strong>Host a quiz or a sweepstakes</strong> - make it fun and bring out that competitive side, charging £1 per entry to find out who the winner will be.</li>
                            <li><strong>Organise an event</strong> - construct some engaging activities and invite your friends and family around. We recommend bake sales, raffles and little stalls to raise funds.</li>
                            <li><strong>Arrange a dinner party</strong> - Don't eat out, instead have some folks around for dinner and rather than spending money on the bill ask your guests to make a donation.</li>
                        </ul>
                        <p>Promoting your fundraising is key! You can raise the profile of your event by spreading the word on Facebook, Twitter and other social sites you may be on.</p>
                    </div>
